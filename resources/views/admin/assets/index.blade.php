...
<div class="flex flex-col gap-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.assets.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors flex items-center gap-2">
