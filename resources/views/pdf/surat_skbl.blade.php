...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan Beda Luas - SILAPU Desa Puspamukti</title>
    <style>
...
<body>
    ...
    <div class="perihal-container">
        <div class="perihal-title">SURAT KETERANGAN BEDA LUAS</div>
    ...
    <div class="body-text">
        ...
        <table class="data-table">
            <tr><td class="label">Luas pada Sertipikat</td><td class="colon">:</td><td>{{ $data['luas_sertifikat'] ?? '......' }} m²</td></tr>
            <tr><td class="label">Luas pada SPPT</td><td class="colon">:</td><td>{{ $data['luas_sppt'] ?? '......' }} m²</td></tr>
            <tr><td class="label">Alamat</td><td class="colon">:</td><td>{{ $alamatLengkap }}</td></tr>
        </table>

        <p style="text-indent: 30px;">Adalah benar warga Desa kami yang telah bertempat tinggal sesuai dengan alamat diatas, ada perbedaan Luas pada Sertipikat dengan SPPT. dikarenakan adanya salah Penulisan / Pencetakan pada SPPT. Data sebenarnya sesuai Sertipikat :</p>

        <table style="margin: 30px 0 30px 40px; font-weight: bold; width: calc(100% - 40px);">
            <tr><td style="width: 45%;">Luas pada Sertipikat</td><td style="width: 5%;">:</td><td>{{ $data['luas_sertifikat'] ?? '.........' }} m²</td></tr>
        </table>
