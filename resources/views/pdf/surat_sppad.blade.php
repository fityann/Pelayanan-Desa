...
<body>
    @php
        ...
        $alamatSekarang = "Desa Puspamukti Kec. Cigalontang";
    ...
    <div class="perihal-container">
        ...
        <div class="perihal-title" style="text-decoration: underline;">ANTAR DESA/KELURAHAN DALAM WILAYAH KECAMATAN</div>
    ...
    <div class="body-text">
        ...
        <table class="data-table">
            ...
            <tr>
                <td class="label">4. Alamat Sekarang</td>
                <td class="colon">:</td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label">5. Alamat Tujuan Pindah</td>
                <td class="colon">:</td>
                <td></td>
            </tr>
            <tr>
                ...
                <td>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 25%;">Kec. Cigalontang</td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td class="label">6. Jumlah Keluarga yang Pindah</td>
                <td class="colon">:</td>
