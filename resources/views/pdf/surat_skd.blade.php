...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan Domisili - SILAPU Desa Puspamukti</title>
    <style>
...
<body>
    ...
    <div class="perihal-container">
        <div class="perihal-title">SURAT KETERANGAN DOMISILI</div>
    ...
    <div class="body-text">
        ...
        <table class="data-table">
            ...
            <tr><td class="label">Nama lengkap</td><td class="colon">:</td><td>{{ $surat->pemohon_name ?? $surat->user?->name ?? 'Warga' }}</td></tr>
            ...
            <tr><td class="label">Status</td><td class="colon">:</td><td>{{ $surat->user?->penduduk?->status_perkawinan ?? '-' }}</td></tr>
        ...
        <p style="text-indent: 30px;">Demikian Surat Keterangan ini saya buat dengan sebenarnya, untuk dipergunakan sebagaimana mestinya.</p>
    </div>
    ...
    <table class="ttd-box">
        <tr>
            ...
            <td>
                ...
                <div style="font-weight: bold;">ATANG RIDWAN, S.Pd.I</div>
            </td>
        </tr>
    </table>
</body>
