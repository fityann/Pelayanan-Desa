...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan Belum Menikah - SILAPU Desa Puspamukti</title>
    <style>
...
<body>
    ...
    <div class="perihal-container">
        <div class="perihal-title">SURAT KETERANGAN BELUM MENIKAH</div>
    ...
    <div class="body-text">
        ...
        <table class="data-table">
            ...
            <tr><td class="label">Status Perkawinan</td><td class="colon">:</td><td>Belum Kawin</td></tr>
        ...
        <p style="text-indent: 30px;">Demikian Surat Keterangan ini dibuat untuk dipergunakan sebagaimana mestinya.</p>
    </div>
