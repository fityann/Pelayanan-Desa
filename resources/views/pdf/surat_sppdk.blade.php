...
<body>
    @php
        ...
        $alamatSekarang = $rawAlamat . (str_contains(strtolower($rawAlamat), 'rt') ? '' : " RT $rtNumber");
    @endphp

    <div class="form-code">
        <span class="form-code-box">F-1.33</span>
    </div>

    <div class="perihal-container">
        <div class="perihal-title">SURAT PENGANTAR PINDAH</div>
        <div class="perihal-title" style="text-decoration: underline;">ANTAR KABUPATEN/KOTA ATAU ANTAR PROVINSI</div>
    ...
    <table class="ttd-box">
        <tr>
            <td>
                ...
                <div style="margin-bottom: 70px;">Camat Cigalontang</div>
