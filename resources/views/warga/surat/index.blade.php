...
<div class="space-y-8 max-w-5xl mx-auto py-6">
    ...
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-900 via-fuchsia-900 to-slate-900 text-white p-6 sm:p-8 shadow-xl border border-white/10">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div class="flex items-center space-x-4">
                <div class="w-14 h-14 bg-gradient-to-tr from-purple-500 to-fuchsia-400 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/30 flex-shrink-0">
                ...
                <div>
                    ...
                    <p class="text-sm text-purple-200/80 mt-1">Pilih jenis surat keterangan yang ingin Anda ajukan secara mandiri.</p>
                </div>
            </div>
    ...
    @if (session('success'))
        <div class="bg-purple-50 border-l-4 border-purple-500 p-4 rounded-xl flex items-center space-x-3 shadow-sm">
            <span class="material-symbols-outlined text-purple-600">check_circle</span>
            <p class="text-sm font-semibold text-purple-900">{{ session('success') }}</p>
        </div>
    @endif
                ...
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 rounded-2xl bg-gradient-to-tr from-purple-500/10 to-fuchsia-500/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                            <span class="material-symbols-outlined text-purple-600 text-2xl">description</span>
                        </div>
                        <span class="px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-purple-50 text-purple-700 border border-purple-200/50">Layanan Aktif</span>
                    </div>

                    <h3 class="text-lg font-extrabold text-gray-900 mb-2 group-hover:text-purple-700 transition-colors">{{ $jenis->nama }}</h3>
                    ...
                    @if ($jenis->syarat)
                        <div class="bg-gray-50/80 rounded-2xl p-3.5 mb-4 border border-gray-100">
                            <p class="text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1 flex items-center gap-1">
                                <span class="material-symbols-outlined text-sm text-purple-600">assignment_turned_in</span>
                ...
                <div>
                    <div class="flex flex-wrap items-center gap-2 mb-4 pt-2 border-t border-gray-100">
                        ...
                        @if (!$jenis->butuh_ttd_fisik)
                            <span class="inline-flex items-center text-[11px] font-semibold text-purple-700 bg-purple-50 px-2.5 py-1 rounded-md">
                    ...
                    <div class="w-full bg-gradient-to-r from-purple-600 via-fuchsia-600 to-pink-600 hover:from-purple-700 hover:via-fuchsia-700 hover:to-pink-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg shadow-purple-600/20 hover:shadow-purple-600/40 transition-all flex items-center justify-center space-x-2 text-sm">
